...
DROP FUNCTION IF EXISTS update_stock_for_order(jsonb);
...
REVOKE ALL ON FUNCTION update_stock_for_order(jsonb) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION update_stock_for_order(jsonb) TO authenticated;